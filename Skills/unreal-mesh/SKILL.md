---
name: unreal-mesh
description: Use when working with Unreal Engine meshes, spatial scene queries, actor placement and blockout, GeometryScript operations, lighting and acoustics checks, performance budgets, decals, procedural geometry, town-building workflows, furnishing, or accessibility validation via Monolith MCP.
---
